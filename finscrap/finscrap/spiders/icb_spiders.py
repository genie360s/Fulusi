    ...
    def parse(self, response):
        ...
        for exchange_rate_data in exchange_rate_datas:
            yield {
                ...
                'Selling (TT/OD)': exchange_rate_data[1].strip() if exchange_rate_data[1] else None,
                'Buying(TT/OD)': exchange_rate_data[2].strip() if exchange_rate_data[2] else None,
                'Selling FC Notes': exchange_rate_data[3].strip() if exchange_rate_data[3] else None,
                'Buying FC Notes(<50$/50Euro)': exchange_rate_data[4].strip() if exchange_rate_data[4] else None,
                'Buying FC Notes(>=50$/50Euro)': exchange_rate_data[5].strip() if exchange_rate_data[5] else None,
            }